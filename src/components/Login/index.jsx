...
const Login = () => {
  ...
  const handleLogin = () => {
    ...
    dispatch(
      setUserInfo({
        fullname: "Luu Hai",
        birthday: "2023-11-09T18:07:53.445Z",
        phone: "",
        address: "",
        school: "",
        "avatar": "https://lh3.googleusercontent.com/a/ACg8ocLiDuJFYuX6gzxyGF9FjeTqtLkPAtGW9hIWzlnETaZz=s96-c",
      })
    );
    navigate("/my/profile");
    console.log("handleLogin ở Login Component");
    setLoading(false);
  };
            ...
            <Stack flex={3}>
              ...
              <Stack spacing={2.5}>
                ...
                >
                  ...
                  <Link to="/register">
                    <Button sx={{ width: "136px" }} variant="contained">
                      Đăng ký
                    </Button>
                  </Link>
                </Stack>
